...
export async function downloadState(target) {
    ...
    await fs.writeFile(localPath, YAML.stringify(result.state, { indent: 2, lineWidth: 120 }), 'utf-8');
 ...
 */
export async function uploadStateIfChanged(target, localPath, expectedGeneration) {
